...
function BebidasGaseosas() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/administracion/especiales/bebidas/gaseosas/").then((res) => {
      setBebida(res.data);
    });
  }, []);
...
export default BebidasGaseosas;
