...
function BebidasLicores() {
  ...
  const [bebidasLicores, setBebida] = useState([]);
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/administracion/especiales/bebidas/licores/").then((res) => {
      setBebida(res.data);
    });
  }, []);

  const actualiza = () => {
    Axios.put("http://localhost:3001/administracion/especiales/bebidas/licores/update", {
    ...
    Axios.post("http://localhost:3001/bitacora/agregar", {
      ...
      descripcionBitacora: codigoActualiza + ': ' + getCookie('usuario') + ' actualizo una bebida Licor',
