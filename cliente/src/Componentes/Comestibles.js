...
function Comestibles() {
  ...
  var [comestibleNuevo, setNuevoComestible] = useState("");
  var [columnaSeleccionada, setColumna] = useState("");

  useEffect(() => {
    Axios.get("http://localhost:3001/comestibles/").then((res) => {
  ...
  const actualizaPais = () => {
    Axios.put("http://localhost:3001/comestibles/update",
      {
