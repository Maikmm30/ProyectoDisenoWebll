...
function Empleados() {
  ...
  const actualiza = () => {
    ...
    Axios.post("http://localhost:3001/bitacora/agregar", {
      ...
      descripcionBitacora: codigoActualiza + ': ' + getCookie('usuario') + ' actualizo un Empleado',
  ...
  const capturaInput = (event) => {
    if (!event.target.value == "") {
      setNuevoEmpleado(event.target.value);
  ...
  const eliminarDato = () => {
    ...
    Axios.post("http://localhost:3001/bitacora/agregar", {
      ...
      usuarioBitacora: getCookie('usuario'),
      rolBitacora: getCookie('rol'),
      descripcionBitacora: codigoBusca + ': ' + getCookie('usuario') + ' elimino un Empleado',
