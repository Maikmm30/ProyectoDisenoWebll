              ...
              <div className="form-group row mt-2 text-center">
                ...
                <div className="text-center col-12  h-25" style={{  backgroundColor: "#C42709"}}>
                  ...
                  <Link to='/administracion/especiales/especialidades/agregar-especialidad'>
                    <div className="col"><i className=" py-3 px-4 text-light rounded-circle fas fa-plus-circle fa-3x"></i></div>
                  </Link>
                    <div className="col"><i className=" py-3 px-4 text-light rounded-circle fas fa-minus-circle fa-3x"></i></div>
